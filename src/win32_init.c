...
//
static GRWLbool loadLibraries(void)
{
    ...
    _grwl.win32.ntdll.instance = _grwlPlatformLoadModule("ntdll.dll");
    ...
    _grwl.win32.user32.instance = _grwlPlatformLoadModule("user32.dll");
    ...
    {
        _grwl.win32.user32.GetDisplayConfigBufferSizes_ = NULL;
        _grwl.win32.user32.QueryDisplayConfig_ = NULL;
        _grwl.win32.user32.DisplayConfigGetDeviceInfo_ = NULL;
    }

    _grwl.win32.dinput8.instance = _grwlPlatformLoadModule("dinput8.dll");
...

    {
        ...
        for (i = 0; names[i]; i++)
        {
            _grwl.win32.xinput.instance = _grwlPlatformLoadModule(names[i]);
    ...
    _grwl.win32.dwmapi.instance = _grwlPlatformLoadModule("dwmapi.dll");
    ...
    _grwl.win32.shcore.instance = _grwlPlatformLoadModule("shcore.dll");
    ...
    _grwl.win32.imm32.instance = _grwlPlatformLoadModule("imm32.dll");
    ...
    _grwl.win32.uxtheme.instance = _grwlPlatformLoadModule("uxtheme.dll");
...
//
static GRWLbool createHelperWindow(void)
{
    MSG msg;
    ...
    _grwl.win32.helperWindowHandle = CreateWindowExW(WS_EX_OVERLAPPEDWINDOW, MAKEINTATOM(_grwl.win32.helperWindowClass),
                                                     ...
                                                     1, NULL, NULL, _grwl.win32.instance, NULL);
...
WCHAR* _grwlCreateWideStringFromUTF8Win32(const char* source)
{
    ...
    target = _grwl_calloc(count, sizeof(WCHAR));
...
void _grwlUpdateKeyNamesWin32(void)
{
    ...
    for (key = GRWL_KEY_SPACE; key <= GRWL_KEY_LAST; key++)
    {
        UINT vk;
        int scancode, length;
        WCHAR chars[16];
        ...
        WideCharToMultiByte(CP_UTF8, 0, chars, 1, _grwl.win32.keynames[key], sizeof(_grwl.win32.keynames[key]), NULL,
                            NULL);
    }
}
